...
#        game.gc.getGame()
    ...
    def getPlotPotentialValue(self,x,y,coastalCity):
        ...
        commerce += plot.calculateBestNatureYield(YieldTypes.YIELD_COMMERCE,PlayerTypes.NO_PLAYER)
        food += plot.calculateBestNatureYield(YieldTypes.YIELD_FOOD,PlayerTypes.NO_PLAYER)
        production += plot.calculateBestNatureYield(YieldTypes.YIELD_PRODUCTION,PlayerTypes.NO_PLAYER)
