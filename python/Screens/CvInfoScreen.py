...
# ToDo - make this work for Tower of Eyes
...
#		print(self.aaWondersBuilt)
	...
	def drawWondersList_BUG(self):
		...
		screen.setTableColumnHeader(self.szWondersTable, 1, sName, 130)
		screen.setTableColumnHeader(self.szWondersTable, 2, sDate, 65)
		screen.setTableColumnHeader(self.szWondersTable, 3, sOwner, 90)
