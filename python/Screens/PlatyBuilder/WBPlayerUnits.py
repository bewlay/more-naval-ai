...
##		screen.addTableControlGFC( "WBUnitList", 8, 10 + screen.getXResolution()/2, iY, iWidth, iHeight, True, True, 24, 24, TableStyles.TABLE_STYLE_STANDARD)
		screen.addTableControlGFC( "WBUnitList", 11, 10 + screen.getXResolution()/2, iY, iWidth, iHeight, True, True, 24, 24, TableStyles.TABLE_STYLE_STANDARD)
...
##		screen.setTableColumnHeader( "WBUnitList", 2, CyTranslator().getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ()), iColWidth * 4)
		screen.setTableColumnHeader( "WBUnitList", 2, CyTranslator().getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ()), iColWidth * 5)
		screen.setTableColumnHeader( "WBUnitList", 3, "ID", iColWidth * 2)
		screen.setTableColumnHeader( "WBUnitList", 4, CyTranslator().getText("TXT_KEY_WB_XLEVEL", ()), iColWidth * 2)
...
##		screen.enableSort("WBUnitList")
		screen.setTableColumnHeader( "WBUnitList", 6, CyTranslator().getText("[ICON_DEFENSE]", ()), iColWidth * 1)
		screen.setTableColumnHeader( "WBUnitList", 7, CyTranslator().getText("[ICON_MOVES]", ()), iColWidth * 1)
		screen.setTableColumnHeader( "WBUnitList", 8, CyTranslator().getText("TXT_KEY_WB_DURATION", ()), iColWidth * 2)
		screen.setTableColumnHeader( "WBUnitList", 9, CyTranslator().getText("TXT_KEY_PROMOTION_HELD", ()), iColWidth * 2)
		screen.setTableColumnHeader( "WBUnitList", 10, "", 10)
		screen.enableSort("WBUnitList")
#Magister Stop
...
##			screen.setTableInt("WBUnitList", 6, iRow, "<font=3>" + str(loopUnit.baseMoves()) + "</font>", "", WidgetTypes.WIDGET_PYTHON, 8300 + i[0], i[1], CvUtil.FONT_CENTER_JUSTIFY)
			screen.setTableInt("WBUnitList", 6, iRow, "<font=3>" + str(loopUnit.baseCombatStrDefense()) + "</font>", "", WidgetTypes.WIDGET_PYTHON, 8300 + i[0], i[1], CvUtil.FONT_CENTER_JUSTIFY)
			screen.setTableInt("WBUnitList", 7, iRow, "<font=3>" + str(loopUnit.baseMoves()) + "</font>", "", WidgetTypes.WIDGET_PYTHON, 8300 + i[0], i[1], CvUtil.FONT_CENTER_JUSTIFY)
			screen.setTableInt("WBUnitList", 8, iRow, "<font=3>" + str(loopUnit.getDuration()) + "</font>", "", WidgetTypes.WIDGET_PYTHON, 8300 + i[0], i[1], CvUtil.FONT_CENTER_JUSTIFY)
			screen.setTableInt("WBUnitList", 9, iRow, "<font=3>" + str(loopUnit.getImmobileTimer()) + "</font>", "", WidgetTypes.WIDGET_PYTHON, 8300 + i[0], i[1], CvUtil.FONT_CENTER_JUSTIFY)
		self.placeUnitMap()
		...
		szBuffer = CyTranslator().getText("TXT_KEY_WB_CITY_ALL", ()) + ' ' + str(len(lUnits))
		screen.setLabel("DeleteUnitsText", "Background", "<font=4b>" + szBuffer + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution() - 100, iY, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
...
#Magister Start
		...
		screen.setImageButton("DeleteCurrentCity", sKillButton, 20, iY, 28, 28, WidgetTypes.WIDGET_PYTHON, 1041, -1)
		szBuffer = CyTranslator().getText("TXT_KEY_WB_CITY_ALL", ()) + ' ' + str(len(lCities))
		screen.setLabel("DeleteCitiesText", "Background", "<font=4b>" + szBuffer + "</font>", CvUtil.FONT_RIGHT_JUSTIFY, screen.getXResolution()/2 - 35, iY, -0.1, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
		screen.setImageButton("DeleteAllCities", sKillButton, screen.getXResolution()/2 - 35, iY, 28, 28, WidgetTypes.WIDGET_PYTHON, 1041, -1)
#Magister Stop
