...
class RevDCMOptionsTab(BugOptionsTab.BugOptionsTab):
	...
	def create(self, screen):
		...
		if not networkGame:
			...
			#DCM options
#			self.addLabel(screen, left, "RevDCM__RevDCM_siege", localText.getText("TXT_KEY_REVDCMTAB_SIEGE_OPTIONS", ()))
...
#			self.addLabel(screen, left, "RevDCM__RevDCM_general", localText.getText("TXT_KEY_REVDCMTAB_BATTLE_OPTIONS", ()))
...
#			self.addLabel(screen, left, "RevDCM__RevDCM_air", localText.getText("TXT_KEY_REVDCMTAB_AIRFORCE_OPTIONS", ()))
...
#			screen.attachHSeparator(right, right + "SepDCM2")
			...
			#IDW options
#			self.addLabel(screen, left, "RevDCM__RevDCMIDW", localText.getText("TXT_KEY_REVDCMTAB_IDW_OPTIONS", ()))
...
#			self.addLabel(screen, left, "RevDCM__RevDCMIDWINFLUENCE", localText.getText("TXT_KEY_REVDCMTAB_INFLUENCE_OPTIONS", ()))
...
#				self.addLabel(screen, left, "RevDCM__RevDCMSS", localText.getText("TXT_KEY_REVDCMTAB_SPY_OPTIONS", ()))
...
#				self.addLabel(screen, left, "RevDCM__Religion", localText.getText("TXT_KEY_REVDCMTAB_RELIGION_OPTIONS", ()))
...
#				screen.attachHSeparator(right, right + "SepRel2")
			...
			# BARBCIV OPTIONS ASSOCIATED WITH REVOLUTIONS NOW
			if (1 < 2):
...
#					screen.attachHSeparator(right, right + "SepDebugTechDiffusion2")
			...
			#Better BTS AI
			if not networkGame:
				self.addLabel(screen, left, "RevDCM__RevDCMInterface", localText.getText("TXT_KEY_REVDCMTAB_BBAI_OPTIONS", ()))
				col1, col2 = self.addMultiColumnLayout(screen, right, 2, "bbaiOptions")
				self.addIntDropdown(screen, col1, col2, "RevDCM__BBAI_DefensePact")
				
			screen.attachHSeparator(left, left + "SepBBAIInterface1")
			screen.attachHSeparator(right, right + "SepBBAIInterface2")
