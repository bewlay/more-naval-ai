...
/************************************************************************************************/
		...
		.def("isCanMoveLimitedBorders", &CvUnitInfo::isCanMoveLimitedBorders, "bool ()")
...
/************************************************************************************************/
		...
		.def("getRevIdxNationalityMod", &CvCivicInfo::getRevIdxNationalityMod, "int ()")
		.def("getRevIdxBadReligionMod", &CvCivicInfo::getRevIdxBadReligionMod, "int ()")
		.def("getRevIdxGoodReligionMod", &CvCivicInfo::getRevIdxGoodReligionMod, "int ()")
