...
/************************************************************************************************/
		...
		// lfgr 04/2024: Expose all remaining useful methods
		.def("getAdvancedStartCost", &CvTechInfo::getAdvancedStartCost, "int()")
		.def("getAdvancedStartCostIncrease", &CvTechInfo::getAdvancedStartCostIncrease, "int()")
		.def("isWater", &CvTechInfo::isWater, "bool()")
...
//FfH: End Add
		...
		// lfgr 04/2024: Expose all remaining useful methods
		.def("getLayerAnimationPath", &CvPromotionInfo::getLayerAnimationPath, "int()")
		.def("isAIControl", &CvPromotionInfo::isAIControl, "bool()")
		.def("isBoarding", &CvPromotionInfo::isBoarding, "bool()")
		.def("isOnlyDefensive", &CvPromotionInfo::isOnlyDefensive, "bool()")
		.def("isDoubleFortifyBonus", &CvPromotionInfo::isDoubleFortifyBonus, "bool()")
		.def("isFear", &CvPromotionInfo::isFear, "bool()")
		.def("isFlying", &CvPromotionInfo::isFlying, "bool()")
		.def("isHeld", &CvPromotionInfo::isHeld, "bool()")
		.def("isHiddenNationality", &CvPromotionInfo::isHiddenNationality, "bool()")
		.def("isIgnoreBuildingDefense", &CvPromotionInfo::isIgnoreBuildingDefense, "bool()")
		.def("isImmortal", &CvPromotionInfo::isImmortal, "bool()")
		.def("isImmuneToCapture", &CvPromotionInfo::isImmuneToCapture, "bool()")
		.def("isImmuneToFear", &CvPromotionInfo::isImmuneToFear, "bool()")
		.def("isImmuneToMagic", &CvPromotionInfo::isImmuneToMagic, "bool()")
		.def("isInvisible", &CvPromotionInfo::isInvisible, "bool()")
		.def("isMutation", &CvPromotionInfo::isMutation, "bool()")
		.def("isNotAlive", &CvPromotionInfo::isNotAlive, "bool()")
		.def("isPrereqAlive", &CvPromotionInfo::isPrereqAlive, "bool()")
		.def("isRemovedByCasting", &CvPromotionInfo::isRemovedByCasting, "bool()")
		.def("isRemovedByCombat", &CvPromotionInfo::isRemovedByCombat, "bool()")
		.def("isRemovedWhenHealed", &CvPromotionInfo::isRemovedWhenHealed, "bool()")
		.def("isSeeInvisible", &CvPromotionInfo::isSeeInvisible, "bool()")
		.def("isTargetWeakestUnit", &CvPromotionInfo::isTargetWeakestUnit, "bool()")
		.def("isTargetWeakestUnitCounter", &CvPromotionInfo::isTargetWeakestUnitCounter, "bool()")
		.def("isTwincast", &CvPromotionInfo::isTwincast, "bool()")
		.def("isValidate", &CvPromotionInfo::isValidate, "bool()")
		.def("isWaterWalking", &CvPromotionInfo::isWaterWalking, "bool()")
		.def("getBetrayalChance", &CvPromotionInfo::getBetrayalChance, "int()")
		.def("getBetterDefenderThanPercent", &CvPromotionInfo::getBetterDefenderThanPercent, "int()")
		.def("getCasterResistModify", &CvPromotionInfo::getCasterResistModify, "int()")
		.def("getCombatCapturePercent", &CvPromotionInfo::getCombatCapturePercent, "int()")
		.def("getCombatHealPercent", &CvPromotionInfo::getCombatHealPercent, "int()")
		.def("getCombatLimit", &CvPromotionInfo::getCombatLimit, "int()")
		.def("getCombatPercentDefense", &CvPromotionInfo::getCombatPercentDefense, "int()")
		.def("getCombatPercentGlobalCounter", &CvPromotionInfo::getCombatPercentGlobalCounter, "int()")
		.def("getCombatPercentInBorders", &CvPromotionInfo::getCombatPercentInBorders, "int()")
		.def("getExtraCombatStr", &CvPromotionInfo::getExtraCombatStr, "int()")
		.def("getExtraCombatDefense", &CvPromotionInfo::getExtraCombatDefense, "int()")
		.def("getFreeXPPerTurn", &CvPromotionInfo::getFreeXPPerTurn, "int()")
		.def("getFreeXPFromCombat", &CvPromotionInfo::getFreeXPFromCombat, "int()")
		.def("getGoldFromCombat", &CvPromotionInfo::getGoldFromCombat, "int()")
		.def("getGroupSize", &CvPromotionInfo::getGroupSize, "int()")
		.def("getModifyGlobalCounter", &CvPromotionInfo::getModifyGlobalCounter, "int()")
		.def("getModifyGlobalCounterOnCombat", &CvPromotionInfo::getModifyGlobalCounterOnCombat, "int()")
		.def("getResistMagic", &CvPromotionInfo::getResistMagic, "int()")
		.def("getSpellCasterXP", &CvPromotionInfo::getSpellCasterXP, "int()")
		.def("getSpellDamageModify", &CvPromotionInfo::getSpellDamageModify, "int()")
		.def("getWorkRateModify", &CvPromotionInfo::getWorkRateModify, "int()")
		.def("getCaptureUnitCombat", &CvPromotionInfo::getCaptureUnitCombat, "UnitCombatTypes() - Captures this kind of unit on victory")
		.def("getPromotionCombatApply", &CvPromotionInfo::getPromotionCombatApply, "PromotionTypes() - Applies this promotion to the enemy in combat")
		.def("getPromotionRandomApply", &CvPromotionInfo::getPromotionRandomApply, "PromotionTypes() - Applies this promotion randomly to the unit itself")
		.def("getPromotionCombatType", &CvPromotionInfo::getPromotionCombatType, "PromotionTypes()")
		.def("getPromotionCombatMod", &CvPromotionInfo::getPromotionCombatMod, "int()")
		.def("getMiscastChance", &CvPromotionInfo::getMiscastChance, "int()")
		.def("getBonusAffinity", &CvPromotionInfo::getBonusAffinity, "int( BonusTypes )")
		.def("getDamageTypeCombat", &CvPromotionInfo::getDamageTypeCombat, "int( DamageTypes )")
		.def("getDamageTypeResist", &CvPromotionInfo::getDamageTypeResist, "int( DamageTypes )")
		.def("isAllowsMoveImpassable", &CvPromotionInfo::isAllowsMoveImpassable, "bool()")
		.def("isAllowsMoveLimitedBorders", &CvPromotionInfo::isAllowsMoveLimitedBorders, "bool()")
		.def("isCastingBlocked", &CvPromotionInfo::isCastingBlocked, "bool()")
		.def("isBlocksUpgrade", &CvPromotionInfo::isBlocksUpgrade, "bool()")
		.def("isBlocksGifting", &CvPromotionInfo::isBlocksGifting, "bool()")
		.def("isUpgradeOutsideBorders", &CvPromotionInfo::isUpgradeOutsideBorders, "bool()")
		.def("isPromotionImmune", &CvPromotionInfo::isPromotionImmune, "bool()")
		;
...
//FfH: End Add
		.def("getDamageTypeCombat", &CvUnitInfo::getDamageTypeCombat, "int (DamageTypes eDamageType)" ) // lfgr 04/2024
/*************************************************************************************************/
/**	FFHBUG denev																				**/
...
/*************************************************************************************************/
		...
		// lfgr 04/2024: Expose all remaining useful methods
		.def("getAdvancedStartCost", &CvUnitInfo::getAdvancedStartCost, "int()")
		.def("getAdvancedStartCostIncrease", &CvUnitInfo::getAdvancedStartCostIncrease, "int()")
		.def("isQuickCombat", &CvUnitInfo::isQuickCombat, "bool()")
		.def("isRenderAlways", &CvUnitInfo::isRenderAlways, "bool()")
		.def("isNoRevealMap", &CvUnitInfo::isNoRevealMap, "bool()")
		.def("isNoUpkeep", &CvUnitInfo::isNoUpkeep, "bool()")
		.def("isAutoRaze", &CvUnitInfo::isAutoRaze, "bool()")
		.def("getBonusAffinity", &CvUnitInfo::getBonusAffinity, "int( BonusTypes )")
		.def("getUnitCombatCollateralImmune", &CvUnitInfo::getUnitCombatCollateralImmune, "int( UnitCombatTypes )")
		.def("getFormationType", &CvUnitInfo::getFormationType, "str")
		.def("isWorkerTrade", &CvUnitInfo::isWorkerTrade, "bool()")
		.def("isMilitaryTrade", &CvUnitInfo::isMilitaryTrade, "bool()")
		;
...
//FfH: End Add
		...
		// lfgr 04/2024: Expose all remaining useful methods
		.def("getAdvancedStartCost", &CvBuildingInfo::getAdvancedStartCost, "int()")
		.def("getAdvancedStartCostIncrease", &CvBuildingInfo::getAdvancedStartCostIncrease, "int()")
		.def("getVisibilityPriority", &CvBuildingInfo::getVisibilityPriority, "float()")
		.def("isApplyFreePromotionOnMove", &CvBuildingInfo::isApplyFreePromotionOnMove, "bool()")
		.def("isHideUnits", &CvBuildingInfo::isHideUnits, "bool()")
		.def("isNoCivicAnger", &CvBuildingInfo::isNoCivicAnger, "bool()")
		.def("isSeeInvisible", &CvBuildingInfo::isSeeInvisible, "bool()")
		.def("isUnhappyProduction", &CvBuildingInfo::isUnhappyProduction, "bool()")
		.def("getCrime", &CvBuildingInfo::getCrime, "int()")
		.def("getFreePromotionPick", &CvBuildingInfo::getFreePromotionPick, "int()")
		.def("getGlobalResistEnemyModify", &CvBuildingInfo::getGlobalResistEnemyModify, "int()")
		.def("getGlobalResistModify", &CvBuildingInfo::getGlobalResistModify, "int()")
		.def("getModifyGlobalCounter", &CvBuildingInfo::getModifyGlobalCounter, "int()")
		.def("getPlotRadius", &CvBuildingInfo::getPlotRadius, "int()")
		.def("getResistMagic", &CvBuildingInfo::getResistMagic, "int()")
		.def("getRemovePromotion", &CvBuildingInfo::getRemovePromotion, "int()")
		.def("getSpecialistCommerceChange", &CvBuildingInfo::getSpecialistCommerceChange, "int(int, int)")
		.def("isVictoryBuilding", &CvBuildingInfo::isVictoryBuilding, "int()")
		.def("getAreaYieldModifier", &CvBuildingInfo::getAreaYieldModifier, "int(int)")
		.def("getSpecialistExtraCommerce", &CvBuildingInfo::getSpecialistExtraCommerce, "int(int)")
		;
