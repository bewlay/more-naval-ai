...
/*************************************************************************************************/
      ...
      SetGlobalDefine("PROMOTION_WATER1", szVal);
        idx = FindInInfoClass(szVal);
        GC.getDefinesVarSystem()->SetValue("PROMOTION_WATER1", idx);

      SetGlobalDefine("PROMOTION_SUN1", szVal);
        idx = FindInInfoClass(szVal);
        GC.getDefinesVarSystem()->SetValue("PROMOTION_SUN1", idx);

      SetGlobalDefine("PROMOTION_LIFE1", szVal);
        idx = FindInInfoClass(szVal);
        GC.getDefinesVarSystem()->SetValue("PROMOTION_LIFE1", idx);
     ...
     SetGlobalDefine("PROMOTION_CHANNELING3", szVal);
      ...
      SetGlobalDefine("SPELL_FEAST", szVal);
        idx = FindInInfoClass(szVal);
        GC.getDefinesVarSystem()->SetValue("SPELL_FEAST", idx);
...
/**********************************************/
/** Tholal AI - more defines                **/
/**********************************************/
      SetGlobalDefine("SPELL_ENTERTAIN", szVal);
        idx = FindInInfoClass(szVal);
        GC.getDefinesVarSystem()->SetValue("SPELL_ENTERTAIN", idx);

	  SetGlobalDefine("SPELL_GIFT_VAMPIRISM", szVal);
        idx = FindInInfoClass(szVal);
        GC.getDefinesVarSystem()->SetValue("SPELL_GIFT_VAMPIRISM", idx);
...
//FfH: End Add
	...
	// lfgr VOTE_CLEANUP 04/2020: Moved here (before SpellInfos) from PostMenuGlobals.
...
//FfH: End Modify
	...
	// lfgr VOTE_CLEANUP: Moved VoteInfo to PreMenuGlobals, before spells
