...
/************************************************************************************************/
		...
		.def("setHasNonAggression", &CyTeam::setHasNonAggression, "void (int /*TeamTypes*/ eTeam, bool bNewValue)")
		.def("isHasPrepareWar", &CyTeam::isHasPrepareWar, "bool (TeamTypes)")
		.def("setHasPrepareWar", &CyTeam::setHasPrepareWar, "void (int /*TeamTypes*/ eTeam, bool bNewValue)")
