...
// MNAI - Puppet States
bool CvTechInfo::isPuppetStateTrading() const
{
...
bool CvSpellInfo::isAllowAutomateTerrain() const
{
...
/**						                                            							**/
/*************************************************************************************************/
    pXML->GetChildXmlValByName(&m_bAllowAuto, "bAllowAuto");
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
m_iEmbassyRefuseAttitudeThreshold(NO_ATTITUDE),
...
/* Victory Strategy AI                                                                          */
/************************************************************************************************/
	pXML->GetChildXmlValByName(&m_iCultureVictoryWeight, "iCultureVictoryWeight", 30);
	pXML->GetChildXmlValByName(&m_iSpaceVictoryWeight, "iSpaceVictoryWeight", 0);
	pXML->GetChildXmlValByName(&m_iConquestVictoryWeight, "iConquestVictoryWeight", 30);
	pXML->GetChildXmlValByName(&m_iDominationVictoryWeight, "iDominationVictoryWeight", 30);
...
/************************************************************************************************/
	...
	pXML->GetChildXmlValByName(&m_iAtPeaceAttitudeDivisor, "iAtPeaceAttitudeDivisor",10);
